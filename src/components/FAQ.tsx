...
export default function FAQ() {
  ...
  const faqs = [
    ...
    { q: 'What ages can join?', a: 'All ages and levels are welcome. Kids, teens, and adults train together in the same warm, supportive roda.' },
    ...
    { q: 'Do you train anywhere besides Concord?', a: 'Our main group trains in Concord, CA. We also have sister groups in Long Beach, CA and León, Mexico.' },
  ];
